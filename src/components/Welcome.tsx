    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.textContainer}>
                <Text style={styles.title}>RJ Bird Building Pvt Ltd</Text>
                <Text style={styles.subtitle}>Welcome to RJ Bird Building. Your trusted partner in construction.</Text>
            </View>
            <View style={styles.logoAboutContainer}>
                ...
                <View style={styles.aboutContainer}>
                    ...
                    <Text style={styles.subtitle2}>RJ Bird Building has been providing top-notch construction services for over 10 years. Our team of experienced professionals ...</Text>
                </View>
            </View>
